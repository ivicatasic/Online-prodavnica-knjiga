				...
				<div id="page">
						<!-- start content -->
							...
							<div id="content">
								...
								<div class="post">
									<center><h1 class="title">Registracija novog korisnika</h1></center>
									...
									<div class="entry">
										...
										<?php
											...
											if(isset($_GET['ok']))
											{
												echo '<font color="blue">Uspešno ste registrovani.</font>';
												echo '<br><br>';
											}
										...
										<div class="form">
											...
											<div class="form">
												...
												<tr>
													<td><b>Pol:</b>&nbsp;&nbsp;</td>
													<td><input type="radio"  value="Male" name="gender" id='m'><label> Muški</label>&nbsp;&nbsp;&nbsp;
														<input type="radio" value="Female" name="gender" id='f'><label>Ženski</label></td>
														<td>&nbsp;</td>
												</tr>
